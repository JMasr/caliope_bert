...
def parse_arguments():
    ...
    parser.add_argument('--epoch', default=4, type=int, help='total epochs (default: 10)')
    ...
    parser.add_argument('--gradient-clip', default=0, type=float, help='gradient clipping (default: -1 i.e., none)')
